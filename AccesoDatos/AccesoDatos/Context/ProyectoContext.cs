...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-4ML0L74;Database=proyecto;Trust Server Certificate=true;User Id=sa;Password=1234567;MultipleActiveResultSets=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83F04A864AD");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83F2E0A7CE9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83F55BC02A9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83FEDB2F45B");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7652D6F6C");
